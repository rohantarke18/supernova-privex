      ...
      <div className="app">
        <header className="topbar">
          ...
          <div className="topbar__right">
            ...
            <WalletButton onAddressChange={handleAddressChange} deposits={revealed ? deposits : undefined} />
          </div>
        </header>
          ...
          {screen === 'trade' && (
            <div className="layout">
              ...
              <div className="positions-bar">
                <Positions address={walletAddress ?? ''} orders={orders} spotPrice={spotPrice} onManage={() => setScreen('orders')} />
              </div>
            </div>
          )}
